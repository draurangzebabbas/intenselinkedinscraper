/*
  # Complete LinkedIn Scraper Authentication Schema

  1. New Tables
    - `users` - User profile information (linked to auth.users)
    - `apify_keys` - Store multiple Apify keys per user
    - `linkedin_profiles` - Store scraped LinkedIn profile data with user ownership
    - `scraping_jobs` - Track scraping operations per user
  ...
  3. Performance
    ...
    - Optimized for profile sharing between users
*/
